...
namespace EventTermProject
{
    public class Serialize
    {
        ...
        public int WriteCartToDB(Object cart, Object loginID)
        {
            ...
            objCommand.Parameters.AddWithValue("@customerEmail", loginID);
            returnValue = objDB.DoUpdateUsingCmdObj(objCommand);
            return returnValue;
        }

        // This function writes the cart to the database.
        public int WriteOrderToDB(Object cart, Object loginID, Object cartTotal, Object custName, Object dateOrdered)
        {
            // First, you must create a Stored Procedure, "UpdateCart" that will provide the
            // functionality to store the byte array for an object in your database
            Byte[] byteArray;
            ...
            objCommand.CommandText = "AddOrder";          // *** CHANGE NAME TO YOUR STORED PROCEDURE'S NAME
            objCommand.CommandType = CommandType.StoredProcedure;
            ...
            objCommand.Parameters.AddWithValue("@vacationPackage", byteArray);
            objCommand.Parameters.AddWithValue("@customerEmail", loginID);
            objCommand.Parameters.AddWithValue("@customerName", custName);
            objCommand.Parameters.AddWithValue("@cartTotal", cartTotal);
            objCommand.Parameters.AddWithValue("@orderDate", dateOrdered);
            returnValue = objDB.DoUpdateUsingCmdObj(objCommand);
            return returnValue;
        }
        ...
        // This function reads the cart from the database.
        public DataSet ReadOrderFromDB()
        {
            // First, you must provide a Stored Procedure named "ReadCart" that will return a byte array 
            SqlCommand objCommand = new SqlCommand();
            DataSet ds;

            objCommand.CommandText = "ReadOrder";            // *** CHANGE NAME TO YOUR STORED PROCEDURE'S NAME
            objCommand.CommandType = CommandType.StoredProcedure;
