...
<div class="row">
    <div class="col-lg-12">
        <asp:GridView ID="gvEvents" CssClass="table table-bordered table-hover" runat="server" AutoGenerateColumns="False" Width="100%" OnSelectedIndexChanged="gvEvents_SelectedIndexChanged">
            <Columns>
