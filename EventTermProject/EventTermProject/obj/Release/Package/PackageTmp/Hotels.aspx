...
<div class="row">
    <div class="col-lg-4 col-lg-offset-4">
        <asp:Button ID="btnSearchEvents" runat="server" CssClass="btn btn-theme btn-default" Text="Search" OnClick="btnSearchEvents_Click"/><br />
...
<div class="row">
    <div class="col-lg-12">
        <asp:GridView ID="gvHotels" CssClass="table table-bordered table-hover" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvHotels_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="Reserved" HeaderText="Avail"/>
                <asp:CommandField ButtonType="Button" HeaderText="Add to Cart" ShowCancelButton="False" ShowSelectButton="True" />
            </Columns>
        </asp:GridView>
    </div>
</div>
